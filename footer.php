...
<footer class="footer">
  <div class="container">
    <a class="footer__logo" href="#">
      <img src="<?php echo get_template_directory_uri(); ?>/images/logo2.png" alt="Green Cape Engineering" />
    </a>
    ...
    <div class="footer__social">
      ...
      <a target="_blank" href="https://www.instagram.com/green_cape_engineering/">
    ...
    <div class="footer__links col2">
      ...
      <a href="#">Support</a>
      <a href="<?php echo site_url('/privacy-notice'); ?>">Privacy Policy</a>
    </div>

    <div class="footer__cta">
      <a href="#contact" class="button">Request Quote</a>
    </div>

    <div class="footer__copyright">
      &copy; Green Cape Engineering
    </div>
  </div>
</footer>
<?php wp_footer() ?>
